...
| 风险等级 | 🟡 中风险 |
| 需确认 | 是 |
| 命令 | `paas-cli create activestrategy --gateway-config=config/gateway.yaml -f config/redis/ncractivestrategy.yaml` |
...
| 风险等级 | 🟢 低风险 |
| 需确认 | 否 |
| 命令 | `paas-cli get activestrategy --gateway-config=config/gateway.yaml -f config/redis/ncractivestrategy.yaml` |
...
| 风险等级 | 🟡 中风险 |
| 需确认 | 是 |
| 命令 | `paas-cli delete activestrategy --gateway-config=config/gateway.yaml -f config/redis/ncractivestrategy.yaml` |
...
| 风险等级 | 🟡 中风险 |
| 需确认 | 是 |
| 命令 | `paas-cli update activestrategy --gateway-config=config/gateway.yaml -f config/redis/ncractivestrategy-update.yaml` |
...
| 风险等级 | 🟡 中风险 |
| 需确认 | 是 |
| 命令 | `paas-cli update activestrategy --gateway-config=config/gateway.yaml -f config/redis/ncractivestrategy-proxyReadMode-update.yaml` |
...
| 风险等级 | 🔴 高风险 |
| 需确认 | 是 |
| 命令 | `paas-cli switch demoteActiveMaster --gateway-config=config/gateway.yaml -f config/redis/redis-demoteActiveMaster.yaml` |
...
| 风险等级 | 🔴 高风险 |
| 需确认 | 是 |
| 命令 | `paas-cli switch promoteActiveSlave --gateway-config=config/gateway.yaml -f config/redis/redis-promoteActiveSlave.yaml` |
...
| 风险等级 | 🔴 高风险 |
| 需确认 | 是 |
| 命令 | `paas-cli switch activestrategy --gateway-config=config/gateway.yaml -f config/redis/autoSwitchResetRecovery.yaml` |
...
| 风险等级 | 🔴 高风险 |
| 需确认 | 是 |
| 命令 | `paas-cli update configLogicMasterRecover --gateway-config=config/gateway.yaml -f config/redis/configLogicMasterRecover.yaml` |
...
| 风险等级 | 🟡 中风险 |
| 需确认 | 是 |
| 命令 | `paas-cli create hotbackupstrategy --gateway-config=config/gateway.yaml -f config/redis/ncrhotbackupstrategy.yaml` |
...
| 风险等级 | 🟢 低风险 |
| 需确认 | 否 |
| 命令 | `paas-cli get hotbackupstrategy --gateway-config=config/gateway.yaml -f config/redis/ncrhotbackupstrategy.yaml` |
...
| 风险等级 | 🟡 中风险 |
| 需确认 | 是 |
| 命令 | `paas-cli delete hotbackupstrategy --gateway-config=config/gateway.yaml -f config/redis/ncrhotbackupstrategy.yaml` |
...
| 风险等级 | 🔴 高风险 |
| 需确认 | 是 |
| 命令 | `paas-cli switch hotbackupstrategy --gateway-config=config/gateway.yaml -f config/redis/switchredishotback.yaml` |
...
| 风险等级 | 🟡 中风险 |
| 需确认 | 是 |
| 命令 | `paas-cli create unitstrategy --gateway-config=config/gateway.yaml -f config/redis/ncrunitstrategy.yaml` |
...
| 风险等级 | 🟢 低风险 |
| 需确认 | 否 |
| 命令 | `paas-cli get unitstrategy --gateway-config=config/gateway.yaml -f config/redis/ncrunitstrategy.yaml` |
...
| 风险等级 | 🟡 中风险 |
| 需确认 | 是 |
| 命令 | `paas-cli delete unitstrategy --gateway-config=config/gateway.yaml -f config/redis/ncrunitstrategy.yaml` |
