...
| 风险等级 | 🟡 中风险 |
| 需确认 | 是 |
| 命令 | `$PAAS_CLI create federatedncrcluster --gateway-config=config/gateway.yaml -f config/fed/ncrcluster.yaml` |
...
| 风险等级 | 🟢 低风险 |
| 需确认 | 否 |
| 命令 | `$PAAS_CLI get federatedncrcluster --gateway-config=config/gateway.yaml -f config/fed/ncrcluster.yaml` |
...
| 风险等级 | 🔴 高风险 |
| 需确认 | 是 |
| 命令 | `$PAAS_CLI delete federatedncrcluster --gateway-config=config/gateway.yaml -f config/fed/ncrcluster.yaml` |
...
| 风险等级 | 🟡 中风险 |
| 需确认 | 是 |
| 命令 | `$PAAS_CLI update federatedncrclusterconfig --gateway-config=config/gateway.yaml -f config/fed/fed-ncrcluster-config-update.yaml` |
...
| 风险等级 | 🟢 低风险 |
| 需确认 | 否 |
| 命令 | `$PAAS_CLI get federatedncrclusterconfig --gateway-config=config/gateway.yaml -f config/fed/fed-ncrcluster-config-get.yaml` |
...
| 风险等级 | 🟡 中风险 |
| 需确认 | 是 |
| 命令 | `$PAAS_CLI create federatedsentinel --gateway-config=config/gateway.yaml -f config/fed/ncrsentinel.yaml` |
...
| 风险等级 | 🟢 低风险 |
| 需确认 | 否 |
| 命令 | `$PAAS_CLI get federatedsentinel --gateway-config=config/gateway.yaml -f config/fed/ncrsentinel.yaml` |
...
| 风险等级 | 🔴 高风险 |
| 需确认 | 是 |
| 命令 | `$PAAS_CLI delete federatedsentinel --gateway-config=config/gateway.yaml -f config/fed/ncrsentinel.yaml` |
...
| 风险等级 | 🟡 中风险 |
| 需确认 | 是 |
| 命令 | `$PAAS_CLI create federatedsentinelcluster --gateway-config=config/gateway.yaml -f config/fed/ncrsentinelcluster.yaml` |
...
| 风险等级 | 🟢 低风险 |
| 需确认 | 否 |
| 命令 | `$PAAS_CLI get federatedsentinelcluster --gateway-config=config/gateway.yaml -f config/fed/ncrsentinelcluster.yaml` |
...
| 风险等级 | 🔴 高风险 |
| 需确认 | 是 |
| 命令 | `$PAAS_CLI delete federatedsentinelcluster --gateway-config=config/gateway.yaml -f config/fed/ncrsentinelcluster.yaml` |
...
| 风险等级 | 🟡 中风险 |
| 需确认 | 是 |
| 命令 | `$PAAS_CLI update federatedsentinelclusterconfig --gateway-config=config/gateway.yaml -f config/fed/fed-ncrcluster-config-update.yaml` |
...
| 风险等级 | 🟢 低风险 |
| 需确认 | 否 |
| 命令 | `$PAAS_CLI get federatedsentinelclusterconfig --gateway-config=config/gateway.yaml -f config/fed/fed-ncrcluster-config-get.yaml` |
